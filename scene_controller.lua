...
function scene_controller:draw_scene()
  ...
  love.graphics.print(self.world.resources["p1_score"], width/4, 20)
  love.graphics.print(self.world.resources["p2_score"], 3*width/4, 20)
  love.graphics.print(self.world.resources["game_state"], width/2, 20)
